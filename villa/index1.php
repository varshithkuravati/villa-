...
<li class="nav-item" role="presentation">
                    <button class="nav-link" id="villa1-tab" data-bs-toggle="tab" data-bs-target="#villa1" type="button" role="tab" aria-controls="villa1" aria-selected="false">Villa1</button>
                  </li>
...
<!--testing started -->
                ...
                <div class="tab-pane fade" id="villa1" role="tabpanel" aria-labelledby="villa1-tab">
                  <div class="row">
                    <div class="col-lg-3">
                      <div class="info-table">
                        <ul>
                          <li>Total Flat Space <span>250 m2</span></li>
                          <li>Floor number <span>2th</span></li>
                          <li>Number of rooms <span>6</span></li>
                          <li>Parking Available <span>no</span></li>
                          <li>Payment Process <span>Bank</span></li>
                        </ul>
                      </div>
                    </div>
